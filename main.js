...
let salida = prompt("Ingrese su destino de salida");
let destino = prompt("Ingrese su destino final");
let trasporte = prompt("Ingrese su trasporte");
    let dias = parseInt(prompt("Ingrese su cantidad de dias del viaje"));
